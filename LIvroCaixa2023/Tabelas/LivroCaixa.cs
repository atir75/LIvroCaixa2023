...
public class LivroCaixa
{
    ...
    public static bool temSaldoParaDebito(double valor)
    {
    ...
    public static double getSaldo()
    {
        ...
        lancamentos.ForEach(lancamento => {
            if (lancamento.tipoLancamento == 'C') saldo -= lancamento.valor;
            else saldo += lancamento.valor;
        });
        return saldo;
    }
    ...
    public static string montaTabela(String titulo) //  
    {
        ...
        Tabela tabela = new Tabela(lancamentos.Count, 6, titulo);
